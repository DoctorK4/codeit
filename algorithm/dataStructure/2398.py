...
print(bst.find_min(bst.root).data)  # 전체 이진 탐색 트리에서 가장 작은 노드 # type: ignore
# type: ignore # root 노드의 오른쪽 부분 트리에서 가장 작은 노드
print(bst.find_min(bst.root.right_child).data)  # type: ignore
