...
class CustomerServiceCenter:
    ...
    def process_complaint(self):
        ...
        if len(self.queue) == 0:
            ...
            target_complain = self.queue.popleft()
            print("{}님의 {} 문의 내용 접수 되었습니다. 담당자가 배정되면 {}로 연락드리겠습니다!".format(target_complain.name, target_complain.content, target_complain.email))
