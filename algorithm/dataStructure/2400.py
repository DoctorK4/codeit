...
class BinarySearchTree:
    ...
    def delete(self, data):
        ...
        # 2-1. 왼쪽 자식만 갖고 있는 경우
        elif node_to_delete.right_child is None:  # type: ignore
            # 지우려는 노드가 루트 노드일 경우
            ...
            elif node_to_delete is parent_node.left_child:  # type: ignore
                parent_node.left_child = node_to_delete.left_child  # type: ignore
                node_to_delete.left_child.parent = parent_node

            # 지우려는 노드가 부모 노드의 오른쪽 자식일 때
            else:  # type: ignore
                parent_node.right_child = node_to_delete.left_child  # type: ignore
                node_to_delete.left_child.parent = parent_node

        # 2-2. 오른쪽 자식만 갖고 있는 경우
        elif node_to_delete.left_child is None:  # type: ignore
            # 지우려는 노드가 루트 노드일 경우
            if node_to_delete is self.root:
            ...
            # 지우려는 노드가 부모 노드의 왼쪽 자식일 때
                ...
                parent_node.left_child = node_to_delete.right_child  # type: ignore
                node_to_delete.right_child.parent = parent_node

            # 지우려는 노드가 부모 노드의 오른쪽 자식일 때
            else:  # type: ignore
                parent_node.right_child = node_to_delete.right_child  # type: ignore
                node_to_delete.right_child.parent = parent_node
        ...
        while temp is not None:
            if data > temp.data:  # 삽입하려는 데이터가 현재 노드 데이터보다 크다면
                ...
                if temp.right_child is None:
                    new_node.parent = temp  # type: ignore
                    temp.right_child = new_node  # type: ignore
                    return
                ...
                if temp.left_child is None:
                    new_node.parent = temp  # type: ignore
                    temp.left_child = new_node  # type: ignore
                    return
