def get_parent_index(complete_binary_tree, index):
    ...
    if complete_binary_tree[parent_node_index]:
...
def get_left_child_index(complete_binary_tree, index):
    ...
    if complete_binary_tree[left_child_index]:
...
def get_right_child_index(complete_binary_tree, index):
    ...
    if complete_binary_tree[right_child_index]:
...
print(tree[left_child_index])  # type: ignore
print(tree[right_child_index])  # type: ignore

# 9번째 노드의 부모 노드의 인덱스를 받아온다
parent_index = get_parent_index(tree, 9)

print(tree[parent_index])  # type: ignore
